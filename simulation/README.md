...
| `membership_sweep.py` | Sweeps measured RPM across the band edges and audits membership coherence for a given state-text/antecedent wording. Prints per-term band separation; writes `membership_sweep.png`, `membership_sweep.npz`. |
